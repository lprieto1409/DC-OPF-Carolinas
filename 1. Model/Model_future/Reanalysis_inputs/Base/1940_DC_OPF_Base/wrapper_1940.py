...
# Input
folder = '/share/infews/lprieto/Paper_2_DC_OPF/'
...
instance = m1.create_instance(folder_era_year + f'/MTS_data_{year}.dat')
instance2 = m2.create_instance(folder_era_year +f'/MTS_data_{year}.dat')
...
#to save outputs
mwh_pd.to_csv(folder_era_year + f'/mwh_{year}.csv')
# vlt_angle_pd.to_csv('vlt_angle.csv')
# on_pd.to_csv('on.csv')
# switch_pd.to_csv('switch.csv')
# srsv_pd.to_csv('srsv.csv')
# nrsv_pd.to_csv('nrsv.csv')
slack_pd.to_csv(folder_era_year + f'/slack_{year}.csv')
flow_pd.to_csv(folder_era_year + f'/flow_{year}.csv')
duals_pd.to_csv(folder_era_year + f'/duals_{year}.csv')
