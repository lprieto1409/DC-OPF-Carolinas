...
folder_inputs = '/share/infews/lprieto/Paper_2_DC_OPF/Model_inputs/'

# Network Inputs (Outages, Load, Generation)
folder_network = '/share/infews/lprieto/Paper_2_DC_OPF/Network_inputs/'

# Reanalysis datasets
folder_era_year = f'/share/infews/lprieto/Paper_2_DC_OPF/Reanalysis_folders/{year}_DC_OPF_Base'
...
df_gen = pd.read_csv(folder_inputs+'data_genparams_partial.csv',header=0)

#read generation and transmission data
df_bustounitmap = pd.read_csv(folder_inputs+'gen_mat.csv',header=0)
df_linetobusmap = pd.read_csv(folder_inputs+'line_to_bus.csv',header=0)
df_line_params = pd.read_csv(folder_inputs+'line_params.csv',header=0)
...
# ##hourly ts of hydro at nodal-level
# df_pumping = pd.read_csv(folder_network + 'data_hydro_P.csv',header=0)
# p_nodes = list(df_pumping.columns)

##hourly ts of dispatchable solar-power at each plant
df_solar = pd.read_csv(folder_era_year + f'/data_solar_{year}.csv',header=0,index_col=0) #Change the file  
...
df_load = pd.read_csv(folder_era_year + f'/data_load_{year}.csv',header=0,index_col=0) #Change the file
...
df_must = pd.read_csv(folder_inputs+'must_run.csv',header=0)
...
######====== write data_year.dat file ======########
with open(''+str(data_name)+f'_{year}.dat', 'w') as f:
